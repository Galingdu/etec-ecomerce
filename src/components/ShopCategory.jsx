    ...
    <div className='px-5 py-3 lg:px-[120px] md:py-10 lg:mt-3' data-aos="fade-up">
        ...
        <div className='flex flex-wrap justify-between items-center md:mt-10'>
            <div className='rounded-3xl mt-3 overflow-hidden relative h-[230px] w-[48%] xl:w-[15%] md:w-[32%]' >
                ...
                <img className='w-full h-full object-cover hover:scale-105 duration-300 cursor-pointer ' src="https://cdn.thewirecutter.com/wp-content/media/2024/11/cheapgaminglaptops-2048px-8004-2x1-1.jpg?width=2048&quality=75&crop=2:1&auto=webp://via.placeholder.com/150" alt="" />
            </div>
            
            <div className='rounded-3xl mt-3 overflow-hidden relative h-[230px] w-[48%] xl:w-[15%] md:w-[32%]' >
                <h2 className='absolute z-3 left-1/2 transform -translate-x-1/2 top-3 font-bold text-white text-2xl'>Phones</h2>
                <img className='w-full h-full object-cover hover:scale-105 duration-300 cursor-pointer ' src="https://cdn.thewirecutter.com/wp-content/media/2024/06/android-phone-2048px-0967.jpg" alt="" />
            </div>
            <div className='rounded-3xl mt-3 overflow-hidden relative h-[230px] w-[48%] xl:w-[15%] md:w-[32%]' >
                ...
                src="https://filmcamerastore.co.uk/cdn/shop/articles/from-point-and-shoot-to-slr-a-guide-to-different-types-of-film-camera.png?v=1723496620&width=1600" alt="" />
            </div>

            <div className='rounded-3xl mt-3 overflow-hidden relative h-[230px] w-[48%] xl:w-[15%] md:w-[32%]' >
                <h2 className='absolute z-3 left-1/2 transform -translate-x-1/2 top-3 font-bold text-white text-2xl'>Keyboard</h2>
                <img className='w-full h-full object-cover hover:scale-105 duration-300 cursor-pointer ' 
                src="https://cdn.thewirecutter.com/wp-content/media/2025/04/mechanicalkeyboards-2048px-1395-2.jpg" alt="" />
            </div>
            <div className='rounded-3xl mt-3 overflow-hidden relative h-[230px] w-[48%] xl:w-[15%] md:w-[32%]' >
                <h2 className='absolute z-3 left-1/2 transform -translate-x-1/2 top-3 font-bold text-white text-2xl'>Speaker</h2>
                <img className='w-full h-full object-cover hover:scale-105 duration-300 cursor-pointer '
                 src="https://images.ctfassets.net/javen7msabdh/3Hst69wqIj3DMdMeFAJTd1/0822fb885d5ad4ff7d60ec81b763a592/middleton-cream-plp.jpg" alt="" />
            </div>

            <div className='rounded-3xl mt-3 overflow-hidden relative h-[230px] w-[48%] xl:w-[15%] md:w-[32%]' >
                <h2 className='absolute z-3 left-1/2 transform -translate-x-1/2 top-3 font-bold text-white text-2xl'>PlayStation</h2>
                <img className='w-full h-full object-cover hover:scale-105 duration-300 cursor-pointer '
                 src="https://media.wired.com/photos/62eabb0e58719fe5c578ec7c/1:1/w_1334,h_1334,c_limit/What-To-Do-With-Old-PS4-Gear.jpg" alt="" />
            </div>
